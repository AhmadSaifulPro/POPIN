                                ...
                                <dir class="row">
                                    <div class="col-xxl-3 col-md-6 pt-2">
                                        <div>
                                            ...
                                            <select class="form-select mb-3" name="siswa_id" aria-label="Default select example">
                                                <option value="{{ $data->siswa_id }}">{{ $data->nama }}</option>
                                    ...
                                    <div class="col-xxl-3 col-md-6 pt-2">
                                        <div>
                                            ...
                                            <input type="date" class="form-control" value="{{ @$data->tanggal }}" name="tanggal" id="placeholderInput" placeholder="Masukan Nama">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-xxl-3 col-md-6 pt-2">
                                    ...
                                    <div class="col-xxl-3 col-md-6 pt-2">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" value="{{ @$data->jumlah }}" name="jumlah" id="placeholderInput" placeholder="Masukan Nama">
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-6 pt-2">
                                        <div>
