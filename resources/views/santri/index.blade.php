                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="text-center">ID Wali Santri</th>
                                            <th class="text-center">Nama Bapak</th>
                                            <th class="text-center">Nama Ibu</th>
                                            <th class="text-center">Tahun Masuk</th>
                                            <th class="text-center">Mukim</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $item->Wali_Santri->nama_wali }}</td>
                                            <td class="text-center">{{ $item->nama_bapak }}</td>
                                            <td class="text-center">{{ $item->nama_ibu }}</td>
                                            <td class="text-center">{{ $item->tahun_masuk }}</td>
                                            <td class="text-center">{{ $item->mukim }}</td>
                                            <td class="text-center">{!!   QrCode::size(120)->generate('http://192.168.110.13:8080/absenQr/'.$item->id)  !!}</td>
